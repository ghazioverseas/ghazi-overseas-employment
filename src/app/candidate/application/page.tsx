...
export default function CandidateApplicationPage() {
  ...
  // Dynamic payment instructions pulled from admin_settings
          ...
          <div>
            ...
            <div className="rounded-2xl border border-[#D7E8D8] bg-[#F8FAF8] p-6 space-y-6">
              <div className="flex items-center gap-3 text-xs font-semibold text-slate-700 bg-white p-3 rounded-xl border border-[#D7E8D8]">
                ...
                <span>
                  Please transfer the mandatory application submission fee of <strong>Rs. {paymentSettings.submissionFee}</strong> using any of the official Ghazi Overseas accounts below, then enter your Transaction Reference ID.
                </span>
              </div>
